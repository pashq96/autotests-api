...
class UpdateExersiseRequestSchema(BaseModel):
    """
    ...
    description: str | None = Field(alias="orderIndex", default_factory=fake.text)
    estimated_time: str | None = Field(alias="estimatedTime", default_factory=fake.estimated_time)


class UpdateExersiseResponseSchema(BaseModel):
    """
    Описание структуры ответа за обновление задания
    """
    exercise: ExerciseSchema
